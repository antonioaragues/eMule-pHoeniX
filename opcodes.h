...
#define	FILEREASKTIME			MIN2MS(29)	//29 mins // [TPT] - If this value changes in official check jitter time
...
#define ED2KLINKFOLDER			_T("links\\") // [TPT] - Save ed2klinks
#define SIVKAFOLDER				_T("Extra Lists\\") // [TPT] - Sivka AutoHL
#define SOURCESAVEFOLDER		_T("Source Lists\\") // [TPT] - khaos::kmod+ Source Lists directory
#define NOTIFIERFOLDER			_T("tbnskin\\") // [TPT] - enkeyDEV(th1) -notifier-
...
// [TPT] - Modified to accept more clients to high uploads servers
#define	MAX_UP_CLIENTS_ALLOWED	/*250*/350	// max. clients allowed regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too low, use DATARATE to adjust uploadspeed per client
// [TPT] - end
...
#define DOWNLOADTIMEOUT			SEC2MS(120)//ika, increased from 100
...
#define	OP_WEBCACHEPACKEDPROT	0x58 //[TPT] - Webcache 1.9 beta3
...
#define OP_RENNSCHWEIN			0x7a	// [TPT] - eWombat SNAFU v2 Rennschwein-Leecher Mod :(
...
#define OP_INCOMPLETE_SHARED_FILES _T("!Incomplete Files")
...
#define OP_FILEINCSTATUS		0x8e	// [TPT] - enkeyDev: ICS - Incomplete part packet (like OP_FILESTATUS)
...
#define ST_SERVERORDER			0x95	// <uint16> // [TPT] - serverOrder
...
#define	ED2KFTSTR_TORRENT		"Torrent"	// value for eD2K tag FT_FILETYPE
...
#define DARK_ID			 0x88784575	// Magic Key, DO NOT CHANGE!
//<<< eWombat [SNAFU_V3]
...
#define ET_INCOMPLETEPARTS		0x3D // [TPT] - enkeyDev: ICS
...
#endif
#define DISPLAY_REFRESH				3			// GUI refresh rate in [s] (emule default is 3 [s])
#define MINIMUM_SEND_BUFFER_SIZE	4000		// The mimimum size of the socket's outpout buffer
