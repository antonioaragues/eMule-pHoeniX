...
void AddPhoenixTextV(UINT uFlags, EDebugLogPriority dlpPriority, LPCTSTR pszLine, va_list argp);

void PXLogV(UINT uFlags, LPCTSTR pszFmt, va_list argp);

void PhoenixLog(LPCTSTR pszLine, ...);
void PhoenixLogError(LPCTSTR pszLine, ...);
void PhoenixLogWarning(LPCTSTR pszLine, ...);

void PhoenixLog(UINT uFlags, LPCTSTR pszLine, ...);
void PhoenixLogError(UINT uFlags, LPCTSTR pszLine, ...);
void PhoenixLogWarning(UINT uFlags, LPCTSTR pszLine, ...);
// [TPT] - Debug log
