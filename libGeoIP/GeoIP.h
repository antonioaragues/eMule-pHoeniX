...
typedef unsigned long uint32_t; // [TPT] - IP Country
...
GEOIP_API GeoIP* GeoIP_open_type (int type, int flags, const char* configDir); // [TPT] - IP Country
GEOIP_API GeoIP* GeoIP_new(int flags, const char* configDir); // [TPT] - IP Country
