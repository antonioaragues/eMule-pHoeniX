...
class CFileDataIO;
class CSearchResultFileDetailSheetInterface;	// [TPT] - SLUGFILLER: modelessDialogs
...
public:
	...
	LPCTSTR	GetFakeComment() const { return m_pszIsFake; } // [TPT] - Fakecheck
	...
	CSearchResultFileDetailSheetInterface*	GetDetailSheetInterface() const { return m_detailSheetInterface; }	// SLUGFILLER: modelessDialogs
	// [TPT] - SLUGFILLER: modelessDialogs
private:
	bool	m_nKademlia;
	uint32	m_nClientID;
	...
	LPTSTR m_pszIsFake; // [TPT] - Fakecheck
	...
	EKnownType	m_eKnown;
	CSearchResultFileDetailSheetInterface*	m_detailSheetInterface;	// [TPT] - SLUGFILLER: modelessDialogs
};
