...
BEGIN_MESSAGE_MAP(CemuleDlg, CTrayDialog)
	...
	ON_WM_SHOWWINDOW()
	ON_MESSAGE(WM_HOTKEY, OnHotKey) // emulEspaña: added by [TPT]-MoNKi [MoNKi: -invisible mode-]
...
BOOL CemuleDlg::OnInitDialog()
{
	...
	if(thePrefs.GetInvisibleMode()) 
		RegisterInvisibleHotKey();	// emulEspaña: added by [TPT]-MoNKi [MoNKi: -invisible mode-]
...
{
	if (*thePrefs.GetMinTrayPTR()){
		// emulEspaña: modified by [TPT]-MoNKi [MoNKi: -invisible mode-]
		/*
		TrayShow();
		ShowWindow(SW_HIDE);
		*/
...
void CemuleDlg::OnClose()
{
	...
	if(thePrefs.GetInvisibleMode()) 
		UnRegisterInvisibleHotKey();	// emulEspaña: added by [TPT]-MoNKi [MoNKi: -invisible mode-]
...
void CemuleDlg::UpdateTrayIcon(int iPercent)
{
	...
	// prepare it up
	//[TPT] - Blinking tray on message info - eMulespaña
	...
	//[TPT] - end: Blinking Tray Icon On Message Recieve [emulEspaña] - End
...
////////////////////////////////////////////////////////////////////
// BEGIN - emulEspaña: added by [TPT]-MoNKi [MoNKi: -invisible mode-]
