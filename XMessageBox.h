...
struct XMSGBOXPARAMS 
{
	XMSGBOXPARAMS()
	{
		...
		MEMZERO(szIcon, sizeof(szIcon));
		MEMZERO(szCustomButtons, sizeof(szCustomButtons));
		MEMZERO(szReportButtonCaption, sizeof(szReportButtonCaption));
		MEMZERO(szCompanyName, sizeof(szCompanyName));
	}
