...
public:
	...
	void SetCumulateBandwidth(bool value); // [TPT] - Cumulate Bandwidth
	void SetMTUValue(uint32 value); // [TPT] - MTU Configuration-
	// [TPT] - NAFC enable
	void SetNAFCEnable(bool value); 
	void SetNAFCdatarate(float value);
	// [TPT] - NAFC enable
...
private:
	...
	bool cumulateBW; // [TPT] - Cumulate Bandwidth
	uint32 minFragMTU; // [TPT] -MTU Configuration-
	// [TPT] - NAFC
	bool nafcEnable; 
	float NAFCdatarate;
	// [TPT] - NAFC
