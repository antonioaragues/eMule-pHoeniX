...
class CFileDetailDialog : public CModelessPropertySheet	// SLUGFILLER: modelessDialogs
{
...
protected:
	...
	CCommentDialog			m_wndFileComments;	// SLUGFILLER: showComments
...
{
public:
	CFileDetailDialogInterface(CPartFile* owner);
