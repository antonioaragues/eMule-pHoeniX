...
public:
	...
	bool	isBusy() {sendLocker.Lock(); bool ret = m_bBusy; sendLocker.Unlock(); return ret;}// [TPT] - Pawcio: MUS
...
protected:
	...
	virtual void	OnConnect(int nErrorCode); // [TPT] - Maella -Accurate measure of bandwidth: eDonkey data + control, network adapter-
