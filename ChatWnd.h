...
// Dialog Data
	...
	void CheckFriendMessageDetails(); // [TPT] - New friend message window
...
protected:
	...
	virtual BOOL OnCommand(WPARAM wParam, LPARAM lParam);	// [TPT]
