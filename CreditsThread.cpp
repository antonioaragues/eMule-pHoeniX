...
void CCreditsThread::InitText()
{
	...
	*/
	...
	sTmp.Format(_T("02:01:Version %s"),theApp.m_strCurVersionLong + _T(" ") + MOD_VERSION); // [TPT]- modID
	m_arCredits.Add(sTmp);
	m_arCredits.Add(_T("01:06:Copyright (C) 2002-2005 Merkur"));
	m_arCredits.Add(_T("S:50"));
    	//[TPT] - This is the pHoeniX teAm
	m_arCredits.Add(_T("02:04:the pHoeniX teAm"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Binomio Karmesi (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:djreno (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Dreamer (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:LeNSMaN (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:MOSTILLO (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Rocky (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Skyw4lker (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Tiberius (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Titu (forum support and tester)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Wizard (webmaster)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Pichuei (coder)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:ikAbOt (coder)"));
	m_arCredits.Add(_T("S:50"));
    	//[TPT] - the pHoeniX teAm end
