...
long CxImage::DrawStringEx(HDC hdc, long x, long y, CXTEXTINFO *pTextType, bool bSetAlpha )
{
	...
	::DrawText(TmpDC, reinterpret_cast<const LPCTSTR>(pTextType->text), len, &pos, /*DT_EDITCONTROL|DT_EXTERNALLEADING|*/DT_NOPREFIX | DT_CALCRECT );
	...
	::DrawText(TmpDC, reinterpret_cast<const LPCTSTR>(pTextType->text),len, &pos, /*DT_EDITCONTROL|DT_EXTERNALLEADING|*/DT_NOPREFIX| pTextType->align );
...
void CxImage::InitTextInfo( CXTEXTINFO *txt )
{
    ...
    _stprintf( txt->lfont.lfFaceName, _T("Arial")) ;
    ...
    // the text 
    _stprintf( txt->text, _T("Sample Text 01234õû")) ; // text
    txt->align  = DT_CENTER;
    return;
}
////////////////////////////////////////////////////////////////////////////////
