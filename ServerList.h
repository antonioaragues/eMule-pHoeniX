...
class CServer;
class CPartFile;	// [TPT] - itsonlyme: cacheUDPsearchResults
...
public:
	...
	CServer*	GetNextServer(const CServer* lastserver, CPartFile *file) const;	// [TPT] - itsonlyme: cacheUDPsearchResults
	...
	uint32		GetServerPosition() const { return serverpos; }
