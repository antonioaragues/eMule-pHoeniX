...
public:
	...
	//uint16	GetPort() const							{return port;} // [TPT] - Aux Ports
	...
	// [TPT] - serverOrder
	uint16  GetServerOrderNumber() const			{return m_uServerOrder;}
	void    SetServerOrderNumber(uint16 uServer)	{m_uServerOrder = uServer;}
	// [TPT] - serverOrder
	
	HICON	GetServerTooltipInfo(CString &info); // [TPT] - MFCK [addon] - New Tooltips [Rayita]
...
private:
	...
	uint16		m_uServerOrder; // [TPT] - serverOrder
};