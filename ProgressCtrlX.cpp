...
#include "MemDC.h"
#include "DrawGdiX.h"
#include "OtherFunctions.h"	// [TPT] - MoNKi: -Support for High Contrast Mode-
...
BEGIN_MESSAGE_MAP(CProgressCtrlX, CProgressCtrl)
	...
	//}}AFX_MSG_MAP
	ON_WM_SYSCOLORCHANGE() // [TPT] - MoNKi: -Downloaded History-
END_MESSAGE_MAP()
...
void CProgressCtrlX::OnSysColorChange() {
	...
	SetGradientColors(clrStart,clrEnd);
	SetTextColor(clrBarText, ::GetSysColor(COLOR_BTNTEXT));
}
// [TPT] - MoNKi: -Support for High Contrast Mode-
